...
network 10.32.32.0  0.0.0.255 area 0
network 10.32.1.0  0.0.255.255 area 32
network 10.32.10.0  0.0.255.255 area 32
network 10.32.50.0  0.0.255.255 area 32
network 10.32.100.0  0.0.255.255 area 32
int gi 0/1
 ip ospf network point-to-point
end
...
conf t
 ...
 NO ip route 10.3232.0.0 255.255.0.0 200.0.0.32
...
!
  voice register pool 1
    id mac 5843.ab5a.c409
    number 1 dn 1
    dtmf-relay sip-notify
    username 3256 password 3256
    codec g711ulaw
!
  voice register pool 2
    id mac 88b9.459e.7d36
    number 1 dn 2
    dtmf-relay sip-notify
    username 32323232 password 32323232
    codec g711ulaw
!
